...
export const metadata: Metadata = {
  title: 'О нас | Профессиональные эксперты в области пожарной безопасности',
  description: 'Узнайте о Институте НПБ - компании с 20-летним опытом в области противопожарной безопасности. Наша команда экспертов готова помочь вам.',
}
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">О нас</h1>
